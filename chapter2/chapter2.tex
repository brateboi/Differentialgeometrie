...
\begin{examples}
    ...
    \begin{enumerate}
        ...
        Mehr noch: Bezüglich der Basis $\{e_{3}, -y e_{1} + x e_{2}\}$ von $T_{(x,y,z)}\Sigma$ mit $(x,y,z)=p$ hat $(DN)_{p}$ die Matrix $\left(\begin{smallmatrix} 0 & 0 \\ 0 & 1 \end{smallmatrix} \right)$.
