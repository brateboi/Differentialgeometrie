...
\begin{proposition}
    ...
    \begin{figure}[H]
        \centering
        \def\svgwidth{20em}
        \input{figures/isometrie_grafik.pdf_tex}
...
\begin{proof}
    ...
    \begin{figure}[H]
        \centering
        \def\svgwidth{15em}
        \input{figures/proof_isometric.pdf_tex}
        % \caption*{Einheitsnormalenfeld}        
    \end{figure}
...
\begin{figure}[H]
    \centering
    \def\svgwidth{15em}
    \input{figures/invariant.pdf_tex}
    % \caption*{Einheitsnormalenfeld}        
\end{figure}
...
\begin{figure}[H]
    ...
    \input{figures/isometrie_ebene.pdf_tex}
\end{figure}
...
\begin{examples}
    ...
    \begin{enumerate}
        ...
        \item $\Sigma = \includegraphics[height=2em]{figures/brezel.pdf} \Iso (\Sigma) = (\mathbb{Z}/2\mathbb{Z})^3$ erzeugt von drei Spiegelungen an Koordinatenebenen.
        \item \includegraphics[height=2em]{figures/ein_huegel.pdf} $\rightarrow O(\mathbb{R}^2)$ 
        \item \includegraphics[height=2em]{figures/drei_huegel.pdf} $\Iso(\Sigma) = \begin{cases}
            S_3  &\text{gleichseitiges Dreieck} \\
            \mathbb{Z}/2\mathbb{Z}  &\text{gleichschenkliges Dreieck}\\
            \{id\}  &\text{sonst}\\
        \end{cases}$
    \end{enumerate}
\end{examples}
